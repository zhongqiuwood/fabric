...
import (
	...
	"github.com/abchain/wood/fabric/core/system_chaincode/api"
	"github.com/abchain/wood/fabric/core/system_chaincode/samplesyscc"
...
func TestExecuteDeploySysChaincode(t *testing.T) {
	...
	systemChaincodes = []*api.SystemChaincode{
		{
			Enabled:   true,
			Name:      "sample_syscc",
			Path:      "github.com/abchain/wood/fabric/core/system_chaincode/samplesyscc",
			InitArgs:  [][]byte{},
	...
	url := "github.com/abchain/wood/fabric/core/system_chaincode/sample_syscc"
	f := "putval"
