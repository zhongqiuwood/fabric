This document serves as an overview of the new features present in
...
`interfaces.go <https://github.com/abchain/fabric/blob/v0.6/core/chaincode/shim/interfaces.go>`__
...
`eventsender.go <https://github.com/abchain/fabric/blob/v0.6/examples/chaincode/go/eventsender/eventsender.go>`__
...
shim <https://github.com/abchain/fabric/tree/v0.6/core/chaincode/shim/java>`__
...
-  For templates of deterministic and properly-written chaincode, see
   the
   `examples <https://github.com/abchain/fabric/tree/v0.6/examples/chaincode>`__
...
`asset-mgmt-with-dynamic-roles.js <https://github.com/abchain/fabric/blob/v0.6/sdk/node/test/unit/asset-mgmt-with-dynamic-roles.js>`__
