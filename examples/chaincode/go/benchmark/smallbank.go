...
func  main()  {
	...
	reg := func() error {
		return api.RegisterECC(&api.EmbeddedChaincode{"mycc", new(SmallbankChaincode)})
	}
...
func systemerror(err string) ([]byte, error) {
	return errormsg(ERROR_SYSTEM_EXCEPTION + ":" + err)
}
