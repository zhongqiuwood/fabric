...
type Gossip struct {
	...
	Payload []byte         `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"`
	IsPull  bool           `protobuf:"varint,4,opt,name=isPull" json:"isPull,omitempty"`
	Dig     *Gossip_Digest `protobuf:"bytes,5,opt,name=dig" json:"dig,omitempty"`
}
...
var fileDescriptor5 = []byte{
	...
	,
}
