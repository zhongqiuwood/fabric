...
type GlobalState struct {
	...
	Cached                  bool     `protobuf:"varint,2,opt,name=cached" json:"cached,omitempty"`
...
func (m *GlobalState) GetCached() bool {
	if m != nil {
		return m.Cached
	}
	return false
...
var fileDescriptor5 = []byte{
	...
	,
}
