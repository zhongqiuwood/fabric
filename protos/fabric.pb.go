...
const (
	...
	Message_SYNC_STATE_HASH_REQUEST Message_Type = 22
	Message_SYNC_STATE_HASH         Message_Type = 23
)
...
func (*SyncStateHashRequest) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{24} }
...
type SyncStateHash struct {
	Request     *SyncStateHashRequest `protobuf:"bytes,1,opt,name=request" json:"request,omitempty"`
...
func (m *SyncStateHash) Reset()                    { *m = SyncStateHash{} }
func (m *SyncStateHash) String() string            { return proto.CompactTextString(m) }
func (*SyncStateHash) ProtoMessage()               {}
func (*SyncStateHash) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{25} }

func (m *SyncStateHash) GetRequest() *SyncStateHashRequest {
	if m != nil {
		return m.Request
	}
	return nil
...
func (m *SyncStateHash) GetBlockHeight() uint64 {
	if m != nil {
...
func (m *SyncStateHash) GetStateHash() []byte {
	if m != nil {
		return m.StateHash
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SyncStateHash)(nil), "protos.SyncStateHash")
...
var fileDescriptor5 = []byte{
	...
	,
}
