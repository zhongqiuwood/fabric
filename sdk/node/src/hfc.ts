   ...
   setAttrs(attrs:string[]): void {
    ...
    private newNetModeTransaction(request:DeployRequest, isBuildRequest:boolean, cb:DeployTransactionCallback):void {
        ...
        let dockerFileContents =
          ...
          "WORKDIR $GOPATH" + "\n\n" +
          "RUN go install build-chaincode && cp src/build-chaincode/vendor/github.com/abchain/fabric/peer/core.yaml $GOPATH/bin && mv $GOPATH/bin/build-chaincode $GOPATH/bin/%s";
