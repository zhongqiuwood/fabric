...
func main() {
	...
	scan(orgdb.GetIterator(orgdb.IndexesCF), db.IndexesCF, nil)
	scan(orgdb.GetIterator(orgdb.BlockchainCF), db.BlockchainCF, blockDetailPrinter)
	scan(orgdb.GetIterator(orgdb.PersistCF), db.PersistCF, nil)
	scan(orgdb.GetIterator(orgdb.StateDeltaCF), db.StateDeltaCF, nil)
	scan(orgdb.GetIterator(orgdb.StateCF), db.StateCF, nil)
